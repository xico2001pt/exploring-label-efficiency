...
classes = {
    ...
    "optimizers": [Adam, SGD, LARS],  # Add the optimizer classes here
    "schedulers": [ExponentialLR, ExpWarmupLR, MultiStepLR, PolynomialLR, CosineAnnealingLR],  # Add the scheduler classes here
